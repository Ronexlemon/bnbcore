...
type BookingRepository interface {
    ...
    GetCheckIns(ctx context.Context, tenantID uuid.UUID, date time.Time) ([]*Booking, error)
    GetCheckOuts(ctx context.Context, tenantID uuid.UUID, date time.Time) ([]*Booking, error)
